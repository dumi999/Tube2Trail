...
ActiveRecord::Schema[7.1].define(version: 2024_03_20_154537) do
  ...
  create_table "liked_activities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["activity_id"], name: "index_liked_activities_on_activity_id"
    t.index ["user_id"], name: "index_liked_activities_on_user_id"
  end
